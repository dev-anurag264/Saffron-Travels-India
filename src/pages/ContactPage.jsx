...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    label: "Email",
    value: "enquire@saffrontravels.in",
    sub: "We reply within 2 hours",
    href: "mailto:enquire@saffrontravels.in",
    ...
    <>
      ...
      <section className="relative pt-36 pb-20 bg-charcoal overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center">
          ...
          >
            Let's Cater your <em className="text-saffron-300">Dream Trip</em>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Fill in your details and our travel expert will craft a personalised
            itinerary within 24 hours, completely free!
          </motion.p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {contactInfo.map((info, i) => {
                ...
                const content = (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-body text-xs text-earth-400 mb-0.5">
                        {info.label}
                      </p>
              ...
              >
                <iframe
                  ...
                  title="Saffron Travels Office Location"
                />
              </motion.div>
            </div>
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="font-body text-earth-500 text-lg mb-6">
                    Thank you! Our travel expert will reach out within 24 hours
                    with a personalised itinerary.
                  </p>
                  <button
                ...
                <>
                  ...
                  <p className="text-earth-500 font-body text-sm mb-8">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={form.message}
                        onChange={handleChange}
                        placeholder="We are a couple of 2 planning our honeymoon in October, looking for 7 nights, interested in Kashmir. Budget around ₹60,000 per person..."
                        rows={4}
                    ...
                    <p className="text-center text-earth-400 font-body text-xs">
                      🔒 Your information is secure. We never share it with
                      third parties.
                    </p>
                  </form>
                </>
