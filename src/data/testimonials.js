export const testimonials = [
  ...
  {
    id: 4,
    name: "Vivek & Ananya Bose",
    location: "Kolkata",
    trip: "Andaman Island Odyssey",
    rating: 5,
    date: "March 2025",
    review:
  ...
  },
  {
    ...
    name: "Rohan Das",
    location: "Kolkata",
    trip: "Sikkim Himalayan Explorer",
    rating: 5,
    date: "March 2025",
    review:
...
export const stats = [
  { value: "4,000+", label: "Happy Travelers", icon: "users" },
  { value: "20+", label: "Destinations Covered", icon: "map" },
  { value: "98%", label: "Satisfaction Rate", icon: "star" },
  { value: "3", label: "Years of Excellence", icon: "award" },
];
