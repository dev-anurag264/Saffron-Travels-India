export const packages = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Traditional Banarasi street food tour",
      "Walk through ancient Varanasi lanes",
    ],
    inclusions: [
      "Hotel Stay",
      "Breakfast",
  ...
  {
    id: 9,
    name: "Coorg Coffee Hills Escape",
    destination: "Coorg",
    duration: "4 Nights / 5 Days",
    price: "₹12,499",
    pricePerPerson: true,
    ...
    groupSize: "2-8 people",
    highlights: [
      "Coffee plantation stay experience",
      "Visit Abbey Falls & Raja's Seat",
      "Dubare Elephant Camp adventure",
      "Scenic drive through misty hills",
      "Authentic Kodava cuisine tasting",
